...
// 创建wankefd,用来notify唤醒subReactor处理新来的channel
int createEventfd()
{
...
EventLoop::EventLoop() : looping_(false), quit_(false), callingPendingFunctiors_(false), threadId_(CurrentThread::tid()), poller_(Poller::newDefaultPoller(this)), wakeupFd_(createEventfd()), wakeupChannel_(new Channel(this, wakeupFd_))
{
